...
from app.core.device_id import load_device_id
...
class EventEmitter:
    ...
    def emit_file_update(self, file_ref: Any, old_entry: Any, new_entry: Any) -> VaultEvent:
        payload = {
            "node_id": file_ref.node_id,
    ...
    def emit_file_delete(self, file_ref: Any, *, file_id: str | None = None) -> VaultEvent:
        payload = {
            "node_id": file_ref.node_id,
            "file_id": file_id,
            "reason": "user_action",
    ...
    def emit_folder_delete(self, folder_ref: Any, *, cascade: bool = True) -> VaultEvent:
        payload = {
            "node_id": folder_ref.node_id,
            "cascade": cascade,
        }
